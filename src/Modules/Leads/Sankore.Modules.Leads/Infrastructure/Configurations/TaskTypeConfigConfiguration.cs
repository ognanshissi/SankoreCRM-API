...
internal sealed class TaskTypeConfigConfiguration : IEntityTypeConfiguration<TaskTypeConfig>
{
    public void Configure(EntityTypeBuilder<TaskTypeConfig> builder)
    {
        builder.ToTable("task_type_configs");
