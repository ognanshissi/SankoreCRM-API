...
namespace Sankore.Modules.Workflow.Infrastructure.Migrations
{
    ...
    [Migration("20260917220923_AddWorkflowComposition")]
    partial class AddWorkflowComposition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sankore.Modules.Workflow.Domain.WorkflowInstance", b =>
                {
                    ...
                    b.Property<Guid?>("WaitingForChildId")
                        .HasColumnType("uuid")
                        .HasColumnName("waiting_for_child_id");
                    ...
                    b.HasIndex("ParentInstanceId")
                        ...
                        .HasFilter("parent_instance_id IS NOT NULL");
