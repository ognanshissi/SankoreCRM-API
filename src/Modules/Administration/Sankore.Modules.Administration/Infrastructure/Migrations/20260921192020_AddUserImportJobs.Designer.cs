...
namespace Sankore.Modules.Administration.Infrastructure.Migrations
{
    ...
    [Migration("20260921192020_AddUserImportJobs")]
    partial class AddUserImportJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("agency_code_seq", "administration");

            modelBuilder.HasSequence<int>("GeneratedIncrementalNo", "shared")
                .StartsAt(1000L)
                .IncrementsBy(5);
            ...
            modelBuilder.Entity("Sankore.Modules.Administration.Domain.CompanyInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sankore.Modules.Administration.Domain.ProductSpeciality", b =>
                {
                    ...
                    b.Property<string>("BusinessPlatformName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("business_platform_name");

                    b.Property<string>("BusinessProductId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("business_product_id");
                    ...
                    b.HasIndex("TenantId", "IsActive")
                        .HasDatabaseName("ix_product_specialities_tenant_id_is_active");

                    b.ToTable("product_specialities", "administration");
                });

            modelBuilder.Entity("Sankore.Modules.Administration.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("refresh_tokens", "administration");
                });
            ...
            modelBuilder.Entity("Sankore.Modules.Administration.Domain.UserImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_import_jobs", "administration");
                });
